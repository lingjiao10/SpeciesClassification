...
class GeneralizedWassersteinDiceLoss(_Loss):
    ...
    """
    def __init__(self, dist_matrix, weighting_mode='default', reduction='mean', adding_ce=False, gamma=1):
        """
        ...
        self.adding_ce = adding_ce #wangcong 加入交叉熵损失
        self.gamma = gamma #GWDL损失的系数
    ...
    def forward(self, input, target):
        ...
        if self.adding_ce:
            ...
            loss = wass_dice_loss * self.gamma + ce_loss
        else:
            loss = wass_dice_loss
